iuhWeaponPrjTHERMITE = iuhWeaponPrjTHERMITE or class(ProjectileBase)

function iuhWeaponPrjTHERMITE:init(unit)
	iuhWeaponPrjTHERMITE.super.init(self, unit, true)
...
function iuhWeaponPrjTHERMITE:set_weapon_unit(weapon_unit)
	iuhWeaponPrjTHERMITE.super.set_weapon_unit(self, weapon_unit)
...
function iuhWeaponPrjTHERMITE:throw(dir)
	local velocity = dir
	local launch_speed = 7500
...
function iuhWeaponPrjTHERMITE:_on_collision(col_ray, weapon_unit, user_unit, damage, blank)
