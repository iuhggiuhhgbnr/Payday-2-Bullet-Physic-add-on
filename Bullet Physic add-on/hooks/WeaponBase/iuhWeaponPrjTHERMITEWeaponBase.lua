iuhWeaponPrjTHERMITEWeaponBase = iuhWeaponPrjTHERMITEWeaponBase or class(ProjectileWeaponBase)

function iuhWeaponPrjTHERMITEWeaponBase:init(unit)
	iuhWeaponPrjTHERMITEWeaponBase.super.init(self, unit)
...
function iuhWeaponPrjTHERMITEWeaponBase:_fire_raycast(user_unit, from_pos, direction, dmg_mul, shoot_player, spread_mul, autohit_mul, suppr_mul, shoot_through_data)
	...
	local unit_name = Idstring("units/mods/weapons/wpn_prj_iuhWeaponPrjTHERMITE/wpn_prj_iuhWeaponPrjTHERMITE")
