iuhWeaponPrjBUCKWeaponBase = iuhWeaponPrjBUCKWeaponBase or class(ProjectileWeaponBase)

function iuhWeaponPrjBUCKWeaponBase:init(unit)
	iuhWeaponPrjBUCKWeaponBase.super.init(self, unit)
...
function iuhWeaponPrjBUCKWeaponBase:_fire_raycast(user_unit, from_pos, direction, dmg_mul, shoot_player, spread_mul, autohit_mul, suppr_mul, shoot_through_data)
