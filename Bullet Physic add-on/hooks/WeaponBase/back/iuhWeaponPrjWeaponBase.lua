iuhWeaponPrjWeaponBase = iuhWeaponPrjWeaponBase or class(ProjectileWeaponBase)

local math_clamp = math.clamp

function iuhWeaponPrjWeaponBase:init(unit)
	iuhWeaponPrjWeaponBase.super.init(self, unit)
...
function iuhWeaponPrjWeaponBase:_fire_raycast(user_unit, from_pos, direction, dmg_mul, shoot_player, spread_mul, autohit_mul, suppr_mul, shoot_through_data)
