iuhWeaponPrjFLAMEWeaponBase = iuhWeaponPrjFLAMEWeaponBase or class(ProjectileWeaponBase)

function iuhWeaponPrjFLAMEWeaponBase:init(unit)
	iuhWeaponPrjFLAMEWeaponBase.super.init(self, unit)
...
function iuhWeaponPrjFLAMEWeaponBase:_fire_raycast(user_unit, from_pos, direction, dmg_mul, shoot_player, spread_mul, autohit_mul, suppr_mul, shoot_through_data)
	...
	mvector3.set(mvec_spread_direction, direction:rotate_with(Rotation(math.random(-1,1), math.random(-1,1), math.random(-1,1))) * i)
	...
	local unit_name = Idstring("units/mods/weapons/wpn_prj_iuhWeaponPrjFLAME/wpn_prj_iuhWeaponPrjFLAME")
